...
if __name__ == "__main__":
	...
	parser.add_argument("-B", "--bag-sizes", dest="bag_sizes", default="[1,10,25,50,100]", type=str, help="")
	parser.add_argument("-M", "--n-single-instances", dest="M", default="[10,50,100,150]", type=str, help="")
